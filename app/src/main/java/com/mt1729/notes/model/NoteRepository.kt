...
class NoteRepository() {
    fun getNotes(): Flow<List<Note>> = flow {
        val notes = listOf(
            ...
            Note(
                "QWEL QWLEJK QLWKEJ ASDL JAS POCXAJC OPIW JQWOIEJ QOW PIJACLSKC LKQJWN KJQNSCK" +
                        "AJNSCK AJNSD QNWE IUNQWE UI@#()@#U )(@U#$ )!(U@ )I@H#O @# U$(*E@H WSC(H " +
                        "IOUHAOIUHWDIUVSDVIU HSOI&\$Y *W&H*&H ALKSJD QWO QIWE J ALKSDJ ALSKD JQOWIE JOSIJ " +
                        "OCIQJOCIJQOWICJQOIWJEASKC2034203948203984203984", listOf(
